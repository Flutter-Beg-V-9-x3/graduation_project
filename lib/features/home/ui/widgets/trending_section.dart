...
class TrendingSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sectionHeight = (screenHeight * 0.55).clamp(320.0, 560.0);
      ...
      child: GestureDetector(
        ...
        child: Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            mainAxisSize:
                MainAxisSize.min, // يمنع التمدد الزائد ويقلل فرص الـ overflow
            children: [
              AspectRatio(
                aspectRatio: 2 / 3, // نسبة شائعة للبوسترات
                child: ClipRRect(
              ...
              Text(
                movie.title,
                maxLines: 1, // يسمح بسطرين → يقلل overflow
              ...
              //  const SizedBox(height: 6), // مسافة تحت لمنع اللصق في الحد السفلي
            ],
          ),
        ),
      ),
