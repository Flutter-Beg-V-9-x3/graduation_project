...
//         // لون بنفسجي شفاف ليعطي تأثير "الإضاءة" (Glow)
...
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               // Avatar "You" - تم تكبير الخط هنا قليلاً
//               Container(
//                 width: 44, // تكبير حجم الدائرة قليلاً لتتناسب مع النص
//                 height: 44,
//                 decoration: BoxDecoration(
...
class _ReviewsSectionState extends State<ReviewsSection> {
  ...
  Widget build(BuildContext context) {
    return Container(
      // التعديل: زيادة الهامش الأفقي إلى 32 لجعل الصندوق أصغر حجماً من حيث العرض
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // Avatar "You" (الحجم الكبير المحسّن)
              Container(
                width: 46,
                height: 46,
                decoration: BoxDecoration(
